...
<head>
    ...
    <link rel="stylesheet" href="plugin/timer/timer.css">
    <link rel="stylesheet" href="plugin/go-to-top/style.css">
    <link rel="stylesheet" href="plugin/rasta-contact/style.css">
                            ...
                            <div class="responsive-menu d-lg-none d-block">
                                ...
                                <div aria-labelledby="responsive menu" class="offcanvas offcanvas-start"
                                    ...
                                    <div class="offcanvas-header">
                                        <h5 class="offcanvas-title" id="offcanvasRightLabel">فروشگاه مهیار</h5>
                        ...
                        <ul class="navbar-nav align-items-center">
                                ...
                                <ul class="main-menu mega-container">
                                    <li class=""><a href=""><i class="bi bi-phone"></i>
                                        ...
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('image/mobiles.png') no-repeat;">
                                    ...
                                    <li class=""><a href=""><i class="bi bi-tablet"></i> تبلت</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('image/tablet-menu.png') no-repeat;">
                                            ...
                                            <li class=""><a class="title my-flex-baseline" href="">تبلت بر اساس قیمت</a>
                                            </li>
                                            ...
                                            <li class=""><a class="title my-flex-baseline" href="">تبلت براساس
                                                کاربری</a>
                                            </li>
                                    ...
                                    <li class="main-menu-sub-active-li"><a href=""><i class="bi bi-shield"></i>آنتی
                                        ویروس</a>
                                        <ul class="main-menu-sub back-menu main-menu-sub-active"
                                            style=" background: #fff url('image/EAV.png') no-repeat;">
                                    ...
                                    <li class=""><a href=""><i class="bi bi-laptop"></i>لبتاپ</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('image/labtop.png') no-repeat;">
                                    ...
                                    <li class=""><a href=""><i class="bi bi-tag"></i>پر فروش ترین ها</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('image/top-sales.jpeg') no-repeat;">
                            ...
                            <li class="nav-item"><a class="nav-link border-animate fromCenter" href="">
                                ...
                                <ul class="list-unstyled shadow-lg back-menu sub-menu mega-container"
                                    style="background: #fff url('image/banner-11.jpg') no-repeat;background-size: 400px !important;">
                            ...
                            <div class="cart-button ms-3">
                                <a class="d-flex align-items-center h-100" data-bs-toggle="offcanvas"
                                   href="#offcanvasCart" role="button" aria-controls="offcanvasCart">
                                    ...
                                    <span class="d-block main-color-two-bg h-40-px lh-40-px px-2 no-hover rounded-end">20 میلیون تومان</span>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        <div class="footer-contact">
            <div class="row gy-2">
                ...
                <div class="col-8">
                    <div class="text-end">
                        <a href="#" class="go-to-top btn border border-dark">بازگشت به بالا <i
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 col-6 w-100-in-400">
                    <div class="footer-col-item">
                        <nav class="navbar">
                            <ul class="navbar-nav">
                                <li class="nav-item"><span class="nav-link font-16 f-800">با مهیار</span></li>
                    ...
                    <div class="footer-col-item">
                        <nav class="navbar">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a href="" class="nav-link">فروش در مهیار</a></li>
        ...
        <div class="footer-app">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <h5 class="text-white text-sm-start text-center">دانلود اپلیکیشن مهیار</h5>
                </div>
                <div class="col-md-8">
                    <nav class="navbar navbar-expand justify-content-sm-end">
                        <ul class="navbar-nav flex-sm-nowrap flex-wrap justify-content-center">
                            <li class="nav-item"><a href="" class="nav-link"><img
                                    src="image/application/app-sibapp.svg" alt=""></a></li>
                            <li class="nav-item"><a href="" class="nav-link"><img
                                    src="image/application/myket-app.png" alt=""></a></li>
                            <li class="nav-item"><a href="" class="nav-link"><img
                                    src="image/application/bazar-app.svg" alt=""></a></li>
                            <li class="nav-item"><a href="" class="nav-link"><img
                                    src="image/application/google-play-app.svg" alt=""></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <div class="footer-description">
            <div class="row align-items-center gy-3">
                <div class="col-lg-8">
                    <h5 class="mb-3">فروشگاه اینترنتی مهیار ، بررسی انتخاب و خرید آنلاین</h5>
                ...
                <div class="col-lg-4">
                    <nav class="navbar navbar-expand justify-content-lg-end justify-content-center">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="" class="nav-link"><img src="image/namad/rezi.png"
                                                                                  class="img-thumbnail" alt=""></a></li>
                            <li class="nav-item"><a href="" class="nav-link"><img src="image/namad/enamad.png"
                                                                                  class="img-thumbnail" alt=""></a></li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="footer-copyright mt-3">
            <div class="row gy-3">
                <div class="col-lg-9">
                    <p class="text-muted font-14"> استفاده از مطالب فروشگاه اینترنتی مهیارفقط برای مقاصد غیرتجاری و با
                        ذکر منبع بلامانع است. کلیه حقوق این سایت متعلق به مهیار می‌باشد. </p>
                </div>
                <div class="col-lg-3">
                    <p class="text-muted font-14 text-end">Copyright © 2022 - 2023 amir-rezaie.ir</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="offcanvas offcanvas-end py-2" tabindex="-1" id="offcanvasCart" aria-labelledby="offcanvasCartLabel">
    <div class="offcanvas-header shadow-md">
        <h5 class="offcanvas-title fw-bold" id="offcanvasCartLabel">سبد خرید <small
                class="text-muted fw-bold font-14 ms-1">(1
            مورد)</small></h5>
        ...
        <ul class="navbar-nav cart-canvas-parent">
                ...
                <div class="cart-canvas">
                    <div class="row align-items-center">
                        <div class="col-4 ps-0">
                            <img src="image/product/wach1.jpg" alt="">
                        </div>
                        <div class="col-8">
                            <h3 class="text-overflow-3 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
            ...
            <li class="nav-item">
                <div class="cart-canvas">
                    <div class="row align-items-center">
                        <div class="col-4 ps-0">
                            <img src="image/product/wach3.jpg" alt="">
                        </div>
                        <div class="col-8">
                            <h3 class="text-overflow-3 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                Automatico Ghost Reserve
                            ...
                            <div class="product-box-suggest-price my-2  d-flex align-items-center justify-content-between">
                                <ins class="font-25 w-100 text-end">2,500,000 <span>تومان</span></ins>
                            </div>
                            <div class="cart-canvas-foot d-flex align-items-center justify-content-between">
                                <div class="cart-canvas-count">
                                    <span>تعداد:</span>
...
<script src="plugin/go-to-top/script.js"></script>
<script src="plugin/rasta-contact/script.js"></script>
